  ...
  static unsigned char asso_values[] =
    {
      ...
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 15, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 30, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 15, 68, 68, 68, 15,
      68, 68, 25, 68, 68, 68, 68, 68, 10, 68,
      15, 68, 15,  5, 68, 10, 68, 68, 68, 68,
      68, 68, 68, 68, 68,  5, 68, 20, 68, 15,
       5,  0, 20, 15, 20,  5, 68, 68,  0,  5,
      20, 30,  5, 68,  0, 20,  5, 10, 20, 68,
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
      68, 68, 68, 68, 68, 68, 68, 68, 68, 68,
...
__csh_lookup_raw (register const char *str, register size_t len)
{
  ...
  static unsigned char lengthtable[] =
    {
       0,  0,  0,  0,  0,  5,  6,  7,  0,  0,  5,  6,  7,  8,
       0, 10, 11, 12, 13, 14, 15, 11,  2,  3, 14,  5, 16, 17,
       8,  0, 10,  6,  7,  3,  0,  5, 11, 17, 13, 19, 15, 16,
      17, 18, 14, 15, 11, 12, 13, 14, 20,  0, 17, 18,  0, 20,
      16,  0, 18,  0,  0, 11,  0,  0,  0,  0,  0, 17
    };
  static struct __csh_hash_lookup wordlist[] =
    {
      ...
      {"offer",16},
      {"force_relay",44},
      {"asymmetric-codecs",39},
      {"strict-source",26},
      {"full-rtcp-attribute",35},
      {"no-redis-update",24},
      {"UNENCRYPTED_SRTP",5},
      {"UNENCRYPTED_SRTCP",7},
      {"AUTHENTICATED_SRTP",15},
      {"ENCRYPTED_SRTP",11},
      {"ENCRYPTED_SRTCP",13},
      {"force relay",46},
      {"generate-mid",32},
      {"trust-address",21},
      {"media-handover",27},
      {"unauthenticated_srtp",8},
      {""},
      {"no-rtcp-attribute",34},
      {"SIP-source-address",22},
      {""},
      {"UNAUTHENTICATED_SRTP",9},
      {"always-transcode",38},
      {""},
      {"authenticated_srtp",14},
      {""}, {""},
      {"force-relay",45},
      {""}, {""}, {""}, {""}, {""},
      {"original-sendrecv",37}
    };
